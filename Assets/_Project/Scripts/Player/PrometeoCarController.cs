...
public class PrometeoCarController : NetworkBehaviour
{
    ...
    */
    ...
    public void Handbrake()
    {
        ...
        if (driftingAxis < 1f)
        {
            FLwheelFriction.extremumSlip = Mathf.Clamp(FLWextremumSlip * handbrakeDriftMultiplier * driftingAxis, 0.1f, 1f);
            frontLeftCollider.sidewaysFriction = FLwheelFriction;

            FRwheelFriction.extremumSlip = Mathf.Clamp(FRWextremumSlip * handbrakeDriftMultiplier * driftingAxis, 0.1f, 1f);
            frontRightCollider.sidewaysFriction = FRwheelFriction;

            RLwheelFriction.extremumSlip = Mathf.Clamp(RLWextremumSlip * handbrakeDriftMultiplier * driftingAxis, 0.1f, 1f);
            rearLeftCollider.sidewaysFriction = RLwheelFriction;

            RRwheelFriction.extremumSlip = Mathf.Clamp(RRWextremumSlip * handbrakeDriftMultiplier * driftingAxis, 0.1f, 1f);
